...
export const huntGemTokens: Action = {
    name: "HUNT_GEM_TOKENS",
    similes: ["FIND_GEM_TOKENS", "SEARCH_GEMS"],
    description: "Search for tokens that match gem criteria",
    validate: async (runtime: IAgentRuntime, message: Memory) => {
        const keywords = ["gem", "hunt", "find", "search", "token", "tokens"];
        const messageText = (
    ...
    handler: async (
        ...
        try {
            ...
            const criteria = {
                volumeThreshold: 1000000, // Example threshold, adjust based on need
